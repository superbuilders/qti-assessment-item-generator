import type { TransformationDiagramProps } from "../src/widgets/registry"
...
export const transformationDiagramExamples: TransformationDiagramProps[] = [
	...
	// Widget key: image_1
	{
		...
		preImage: {
			...
			fillColor: "#E0F2FA",
			angleMarks: [{ label: "123°", radius: 18, vertexIndex: 2, labelDistance: 22 }],
			sideLengths: [
	...
	// Widget key: image_1
	{
		...
		preImage: {
			...
			fillColor: "#00000000",
			angleMarks: [{ label: "40°", radius: 12.5, vertexIndex: 2, labelDistance: 18 }],
			sideLengths: [],
			strokeColor: "#000000",
			vertexLabels: ["B", "C", "A"]
		},
	...
	// Widget key: image_1
	{
		...
		preImage: {
			...
			fillColor: "#A7C7E780",
			angleMarks: [{ label: "20°", radius: 18, vertexIndex: 0, labelDistance: 14 }],
			sideLengths: [
	...
	// Widget key: image_1
	{
		...
		preImage: {
			...
			fillColor: "#CCE5FF",
			angleMarks: [{ label: "18°", radius: 20, vertexIndex: 0, labelDistance: 12 }],
			sideLengths: [
	...
	// Widget key: image_1
	{
		...
		preImage: {
			...
			fillColor: "#CCE5FF80",
			angleMarks: [{ label: "90°", radius: 12, vertexIndex: 0, labelDistance: 16 }],
			sideLengths: [
