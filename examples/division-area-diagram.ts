...
export const divisionAreaDiagramExamples_51_div_3: DivisionAreaDiagramProps[] = [
  ...
  },
  {
    ...
    steps: [
      { subtrahend: 30, difference: 21, differenceColor: "red", topTokens: null, subtrahendTokens: null, differenceTokens: null, rightPanel: null },
      { subtrahend: null, difference: null, differenceColor: null, topTokens: null, subtrahendTokens: null, differenceTokens: null, rightPanel: null }
    ],
    showFinalRemainderBox: false
  },
  {
    ...
    steps: [
      { subtrahend: 30, difference: 21, differenceColor: "red", topTokens: null, subtrahendTokens: null, differenceTokens: null, rightPanel: null },
      { subtrahend: null, difference: 21, differenceColor: "red", topTokens: null, subtrahendTokens: null, differenceTokens: null, rightPanel: null }
    ],
    showFinalRemainderBox: false
  },
  {
    ...
    steps: [
      { subtrahend: 30, difference: 21, differenceColor: "red", topTokens: null, subtrahendTokens: null, differenceTokens: null, rightPanel: null },
      { subtrahend: 21, difference: 0, differenceColor: null, topTokens: null, subtrahendTokens: null, differenceTokens: null, rightPanel: null }
    ],
...
export const divisionAreaDiagramExamples_28_div_2: DivisionAreaDiagramProps[] = [
  ...
  },
  {
    ...
    steps: [
      { subtrahend: 20, difference: 8, differenceColor: "red", topTokens: null, subtrahendTokens: null, differenceTokens: null, rightPanel: null },
      { subtrahend: null, difference: null, differenceColor: null, topTokens: null, subtrahendTokens: null, differenceTokens: null, rightPanel: null }
    ],
    showFinalRemainderBox: false
  },
  {
    ...
    steps: [
      { subtrahend: 20, difference: 8, differenceColor: "red", topTokens: null, subtrahendTokens: null, differenceTokens: null, rightPanel: null },
      { subtrahend: null, difference: 8, differenceColor: "red", topTokens: null, subtrahendTokens: null, differenceTokens: null, rightPanel: null }
    ],
    showFinalRemainderBox: false
  },
  {
    ...
    steps: [
      { subtrahend: 20, difference: 8, differenceColor: "red", topTokens: null, subtrahendTokens: null, differenceTokens: null, rightPanel: null },
      { subtrahend: 8, difference: 0, differenceColor: null, topTokens: null, subtrahendTokens: null, differenceTokens: null, rightPanel: null }
    ],
    showFinalRemainderBox: true
  }
]
    ...
    steps: [
      {
        ...
        topTokens: [ { type: "digit", value: 6, color: null }, { type: "digit", value: 2, color: null } ],
        subtrahendTokens: [ { type: "boxedDigit", value: 0, color: null }, { type: "boxedDigit", value: 0, color: null } ],
        differenceTokens: [ { type: "digit", value: 2, color: "red" }, { type: "digit", value: 2, color: "red" } ],
        rightPanel: { tokensTop: [ { type: "digit", value: 2, color: "red" }, { type: "digit", value: 2, color: "red" } ], minusTokens: null, bottomTokens: null }
      },
      {
        subtrahend: null,
        difference: null,
    ...
    steps: [
      {
        ...
        differenceColor: "red",
        topTokens: [ { type: "digit", value: 6, color: null }, { type: "digit", value: 2, color: null } ],
        subtrahendTokens: [ { type: "digit", value: 4, color: null }, { type: "digit", value: 0, color: null } ],
        differenceTokens: [ { type: "digit", value: 2, color: "red" }, { type: "digit", value: 2, color: "red" } ],
        rightPanel: { tokensTop: [ { type: "digit", value: 2, color: "red" }, { type: "digit", value: 2, color: "red" } ], minusTokens: null, bottomTokens: null }
      },
      {
        ...
        differenceColor: null,
        topTokens: null,
        subtrahendTokens: [ { type: "digit", value: 2, color: null }, { type: "digit", value: 0, color: null } ],
    ...
    steps: [
      {
        ...
        difference: null,
        differenceColor: null,
        topTokens: [ { type: "digit", value: 9, color: null }, { type: "digit", value: 9, color: null } ],
        subtrahendTokens: [ { type: "boxedDigit", value: 0, color: null }, { type: "boxedDigit", value: 0, color: null } ],
        differenceTokens: [ { type: "digit", value: 3, color: "red" }, { type: "digit", value: 9, color: "red" } ],
        rightPanel: { tokensTop: [ { type: "digit", value: 3, color: "red" }, { type: "digit", value: 9, color: "red" } ], minusTokens: null, bottomTokens: null }
      },
      { subtrahend: null, difference: null, differenceColor: null, topTokens: null, subtrahendTokens: null, differenceTokens: null, rightPanel: null }
    ],
    showFinalRemainderBox: false
...
export const divisionAreaDiagramExamples_954_div_9: DivisionAreaDiagramProps[] = [
  // State 1: Plan to subtract 900 (9 × 100). Show 954 on top, minus row with boxed 9 0 0, bring 54 to the right.
  {
    ...
    dividend: 954,
    quotientParts: [
      { type: "value", value: 100, color: "blue" },
      { type: "placeholder" }
    ],
    steps: [
      {
        ...
        difference: null,
        differenceColor: null,
        topTokens: [ { type: "digit", value: 9, color: null }, { type: "digit", value: 5, color: null }, { type: "digit", value: 4, color: null } ],
        subtrahendTokens: [ { type: "boxedDigit", value: 9, color: null }, { type: "boxedDigit", value: 0, color: null }, { type: "boxedDigit", value: 0, color: null } ],
        differenceTokens: [ { type: "digit", value: 5, color: "red" }, { type: "digit", value: 4, color: "red" } ],
        rightPanel: { tokensTop: [ { type: "digit", value: 5, color: "red" }, { type: "digit", value: 4, color: "red" } ], minusTokens: null, bottomTokens: null }
      },
      { subtrahend: null, difference: null, differenceColor: null, topTokens: null, subtrahendTokens: null, differenceTokens: null, rightPanel: null }
    ],
    showFinalRemainderBox: false
  ...
  // State 2: Commit subtraction of 900 and show remainder 54 below.
  {
    ...
    steps: [
      { subtrahend: 900, difference: 54, differenceColor: "red", topTokens: null, subtrahendTokens: null, differenceTokens: null, rightPanel: null },
      { subtrahend: null, difference: null, differenceColor: null, topTokens: null, subtrahendTokens: null, differenceTokens: null, rightPanel: null }
    ],
    showFinalRemainderBox: false
  },
    ...
    steps: [
      {
        ...
        differenceColor: "red",
        topTokens: [ { type: "digit", value: 9, color: null }, { type: "digit", value: 5, color: null }, { type: "digit", value: 4, color: null } ],
        subtrahendTokens: [ { type: "digit", value: 9, color: null }, { type: "digit", value: 0, color: null }, { type: "digit", value: 0, color: null } ],
        differenceTokens: [ { type: "digit", value: 5, color: "red" }, { type: "digit", value: 4, color: "red" } ],
        rightPanel: { tokensTop: [ { type: "digit", value: 5, color: "red" }, { type: "digit", value: 4, color: "red" } ], minusTokens: null, bottomTokens: null }
      },
      {
        ...
        differenceColor: null,
        topTokens: null,
        subtrahendTokens: [ { type: "digit", value: 5, color: null }, { type: "digit", value: 4, color: null } ],
...
export const divisionAreaDiagramExamples_809_div_4: DivisionAreaDiagramProps[] = [
  // State 1: Plan to subtract 800 (4 × 200). Show 809 on top, minus row boxed 8 0 0, bring 9 to the right.
  {
    ...
    dividend: 809,
    quotientParts: [
      { type: "value", value: 200, color: "blue" },
      { type: "placeholder" }
    ],
    steps: [
      {
        ...
        difference: null,
        differenceColor: null,
        topTokens: [ { type: "digit", value: 8, color: null }, { type: "digit", value: 0, color: null }, { type: "digit", value: 9, color: null } ],
        subtrahendTokens: [ { type: "boxedDigit", value: 8, color: null }, { type: "boxedDigit", value: 0, color: null }, { type: "boxedDigit", value: 0, color: null } ],
  ...
  // State 2: Commit subtraction of 800 and show remainder 9 below.
  {
    ...
    steps: [
      { subtrahend: 800, difference: 9, differenceColor: "red", topTokens: null, subtrahendTokens: null, differenceTokens: null, rightPanel: null },
      { subtrahend: null, difference: null, differenceColor: null, topTokens: null, subtrahendTokens: null, differenceTokens: null, rightPanel: null }
    ],
    showFinalRemainderBox: false
  },
    ...
    steps: [
      {
        ...
        differenceColor: "red",
        topTokens: [ { type: "digit", value: 8, color: null }, { type: "digit", value: 0, color: null }, { type: "digit", value: 9, color: null } ],
        subtrahendTokens: [ { type: "digit", value: 8, color: null }, { type: "digit", value: 0, color: null }, { type: "digit", value: 0, color: null } ],
        differenceTokens: [ { type: "digit", value: 9, color: "red" } ],
        rightPanel: { tokensTop: [ { type: "digit", value: 9, color: "red" } ], minusTokens: null, bottomTokens: null }
      },
      {
