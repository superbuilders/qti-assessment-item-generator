...
const RAW_NUMBER_LINE_EXAMPLES: NumberLineWithoutNulls[] = [
	...
	// Widget key: image_1
	{
		...
		showTickLabels: true,
		highlightedPoints: [
			{ type: "mathml", color: "#a75a05", style: "dot", mathml: "<mtext>Carbon dioxide</mtext>", position: -78 },
			{ type: "mathml", color: "#0c7f99", style: "dot", mathml: "<mtext>Water</mtext>", position: 0 }
		],
		secondaryTickInterval: null
	},
	...
	// Widget key: image_1
	{
		...
		showTickLabels: true,
		highlightedPoints: [
			{ type: "mathml", color: "#a75a05", style: "dot", mathml: "<mtext>Kendra</mtext>", position: -6 },
			{ type: "mathml", color: "#0c7f99", style: "dot", mathml: "<mtext>Jamal</mtext>", position: 0 }
		],
		secondaryTickInterval: null
	},
	...
	// Widget key: image_1
	{
		...
		showTickLabels: false,
		highlightedPoints: [
			{ type: "mathml", color: "#a75a05", style: "dot", mathml: "<mtext>Temuco</mtext>", position: 7 }
		],
		secondaryTickInterval: null
	},
	...
	// Widget key: image_1
	{
		...
		showTickLabels: true,
		highlightedPoints: [
			{ type: "mathml", color: "#a75a05", style: "dot", mathml: "<mtext>Carrie's bill</mtext>", position: 75 }
		],
		secondaryTickInterval: null
	},
	...
	// Widget key: image_1
	{
		...
		showTickLabels: false,
		highlightedPoints: [
			{ type: "mathml", color: "#000000", style: "dot", mathml: "<mtext>sea level</mtext>", position: 0 },
			{ type: "mathml", color: "#a75a05", style: "dot", mathml: "<mtext>Lhasa</mtext>", position: 3656 }
		],
		secondaryTickInterval: null
	},
	...
	// Widget key: image_1
	{
		...
		showTickLabels: true,
		highlightedPoints: [
			{ type: "mathml", color: "#0c7f99", style: "dot", mathml: "<mtext>sea level</mtext>", position: 0 },
			{ type: "mathml", color: "#a75a05", style: "dot", mathml: "<mtext>New Orleans</mtext>", position: -2 }
		],
		secondaryTickInterval: null
	},
	...
	// Widget key: image_1
	{
		...
		showTickLabels: true,
		highlightedPoints: [
			{ type: "mathml", color: "#0c7f99", style: "dot", mathml: "<mtext>hole</mtext>", position: 0 },
			{ type: "mathml", color: "#a75a05", style: "dot", mathml: "<mtext>bean bag</mtext>", position: -4 }
		],
		secondaryTickInterval: null
	},
	...
	// Widget key: image_1
	{
		...
		showTickLabels: true,
		highlightedPoints: [
			{ type: "mathml", color: "#E67E22", style: "dot", mathml: "<mtext>Lima</mtext>", position: 154 },
			{ type: "mathml", color: "#333333", style: "dot", mathml: "<mtext>sea level</mtext>", position: 0 }
		],
		secondaryTickInterval: null
	},
	...
	// Widget key: image_1
	{
		...
		highlightedPoints: [
			{ type: "mathml", color: "#0c7f99", style: "dot", mathml: "<mtext>Hole</mtext>", position: 0 },
			{ type: "mathml", color: "#a75a05", style: "dot", mathml: "<mtext>Marble</mtext>", position: 3 }
		],
		secondaryTickInterval: null
	},
	...
	// Widget key: number_line_choice_a
	{
		...
		showTickLabels: true,
		highlightedPoints: [
			{ type: "mathml", color: "#ffa500", style: "dot", mathml: "<mo>-</mo><mi>C</mi>", position: 0.5 }
		],
		secondaryTickInterval: null
	},
	// Extracted from question: x6d35fcf1b7fa9959
	...
	// Widget key: number_line_choice_c
	{
		...
		showTickLabels: true,
		highlightedPoints: [
			{ type: "mathml", color: "#ffa500", style: "dot", mathml: "<mo>-</mo><mi>C</mi>", position: -1.5 }
		],
		secondaryTickInterval: null
	},
	...
	// Widget key: nl_choice_b
	{
		...
		showTickLabels: true,
		highlightedPoints: [
			{ type: "mathml", color: "#ffa500", style: "dot", mathml: "<mo>-</mo><mi>A</mi>", position: -3 },
	...
	// Widget key: nl_choice_a
	{
		...
		showTickLabels: true,
		highlightedPoints: [
			{ type: "mathml", color: "#6495ED", style: "dot", mathml: "<mo>-</mo><mi>F</mi>", position: 0.5 }
		],
		secondaryTickInterval: null
	},
	// Extracted from question: xf24d398f5541a761
	...
	// Widget key: nl_choice_c
	{
		...
		showTickLabels: true,
		highlightedPoints: [
			{ type: "mathml", color: "#6495ED", style: "dot", mathml: "<mo>-</mo><mi>F</mi>", position: 1.5 }
		],
		secondaryTickInterval: null
	},
	...
	// Widget key: image_1
	{
		...
		showTickLabels: false,
		highlightedPoints: [
			{ type: "mathml", color: "#000000", style: "dot", mathml: "<mi>A</mi>", position: -4 },
			{ type: "mathml", color: "#000000", style: "dot", mathml: "<mi>B</mi>", position: -2 },
			{ type: "mathml", color: "#000000", style: "dot", mathml: "<mi>C</mi>", position: 6 },
			{ type: "mathml", color: "#000000", style: "dot", mathml: "<mi>D</mi>", position: 7 },
			{ type: "mathml", color: "#000000", style: "dot", mathml: "<mi>E</mi>", position: 10 }
		],
		secondaryTickInterval: null
	},
	...
	// Widget key: nl_choice_a
	{
		...
		showTickLabels: true,
		highlightedPoints: [
			{ type: "mathml", color: "#E67E22", style: "dot", mathml: "<mo>-</mo><mi>A</mi>", position: 0 }
		],
		secondaryTickInterval: null
	},
	// Extracted from question: xc1ac295ed6fa5fa1
	...
	// Widget key: nl_choice_c
	{
		...
		showTickLabels: true,
		highlightedPoints: [
			{ type: "mathml", color: "#8E44AD", style: "dot", mathml: "<mo>-</mo><mi>A</mi>", position: 3 }
		],
		secondaryTickInterval: null
	},
	...
	// Widget key: nl_choice_a
	{
		...
		showTickLabels: true,
		highlightedPoints: [
			{ type: "mathml", color: "#E67E22", style: "dot", mathml: "<mo>-</mo><mi>E</mi>", position: 2.5 }
		],
		secondaryTickInterval: { type: "fraction", denominator: 2 }
	},
	// Extracted from question: x0a5a1f1a80352070
	...
	// Widget key: nl_choice_c
	{
		...
		showTickLabels: true,
		highlightedPoints: [
			{ type: "mathml", color: "#E67E22", style: "dot", mathml: "<mo>-</mo><mi>E</mi>", position: -3 }
		],
		secondaryTickInterval: { type: "fraction", denominator: 2 }
	},
	...
	// Widget key: image_1
	{
		...
		showTickLabels: false,
		highlightedPoints: [
			{ type: "mathml", color: "#000000", style: "dot", mathml: "<mi>A</mi>", position: -5 },
			{ type: "mathml", color: "#000000", style: "dot", mathml: "<mi>B</mi>", position: -4 },
			{ type: "mathml", color: "#000000", style: "dot", mathml: "<mi>C</mi>", position: -2 },
			{ type: "mathml", color: "#000000", style: "dot", mathml: "<mi>D</mi>", position: 2 },
			{ type: "mathml", color: "#000000", style: "dot", mathml: "<mi>E</mi>", position: 5 }
		],
		secondaryTickInterval: null
	},
	...
	// Widget key: choice_a_number_line
	{
		...
		showTickLabels: true,
		highlightedPoints: [
			{ type: "mathml", color: "#ffa500", style: "dot", mathml: "<mo>-</mo><mi>D</mi>", position: -1.5 }
		],
		secondaryTickInterval: null
	},
	// Extracted from question: x48c1bee527871e57
	...
	// Widget key: choice_c_number_line
	{
		...
		showTickLabels: true,
		highlightedPoints: [
			{ type: "mathml", color: "#ffa500", style: "dot", mathml: "<mo>-</mo><mi>D</mi>", position: 0.5 }
		],
		secondaryTickInterval: null
	},
	...
	// Widget key: image_1
	{
		...
		showTickLabels: false,
		highlightedPoints: [
			{ type: "mathml", color: "#000000", style: "dot", mathml: "<mi>A</mi>", position: -7 },
			{ type: "mathml", color: "#000000", style: "dot", mathml: "<mi>B</mi>", position: -2 },
			{ type: "mathml", color: "#000000", style: "dot", mathml: "<mi>C</mi>", position: 3 },
			{ type: "mathml", color: "#000000", style: "dot", mathml: "<mi>D</mi>", position: 4 },
			{ type: "mathml", color: "#000000", style: "dot", mathml: "<mi>E</mi>", position: 7 }
		],
		secondaryTickInterval: null
	},
	...
	// Widget key: image_1
	{
		...
		highlightedPoints: [
			{ type: "mathml", color: "#000000", style: "dot", mathml: "<mi>A</mi>", position: -4 },
			{ type: "mathml", color: "#000000", style: "dot", mathml: "<mi>B</mi>", position: -2 },
			{ type: "mathml", color: "#000000", style: "dot", mathml: "<mi>C</mi>", position: 4 },
			{ type: "mathml", color: "#000000", style: "dot", mathml: "<mi>D</mi>", position: 7 },
			{ type: "mathml", color: "#000000", style: "dot", mathml: "<mi>E</mi>", position: 9 }
		],
		secondaryTickInterval: null
	}
]
