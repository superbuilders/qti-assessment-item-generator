...
export const histogramExamples: HistogramProps[] = [
	{
		bins: [{ frequency: 1 }, { frequency: 2 }, { frequency: 2 }, { frequency: 2 }],
		type: "histogram",
		title: "Histogram",
		width: 500,
	...
	{
		bins: [{ frequency: 1 }, { frequency: 1 }, { frequency: 3 }, { frequency: 2 }],
		type: "histogram",
		title: "Histogram",
		width: 500,
		xAxis: { label: "Number of emails sent" },
	...
	{
		bins: [{ frequency: 0 }, { frequency: 3 }, { frequency: 2 }, { frequency: 2 }],
		type: "histogram",
		title: "Histogram",
		width: 500,
		xAxis: { label: "Number of emails sent" },
	...
	{
		bins: [{ frequency: 1 }, { frequency: 1 }, { frequency: 2 }, { frequency: 3 }],
		type: "histogram",
		title: "Red Candy Pieces per Bag",
		width: 500,
		xAxis: { label: "Number of red candy pieces" },
	...
	{
		bins: [{ frequency: 2 }, { frequency: 1 }, { frequency: 1 }, { frequency: 3 }],
		type: "histogram",
		title: "Red Candy Pieces per Bag",
		width: 500,
		xAxis: { label: "Number of red candy pieces" },
