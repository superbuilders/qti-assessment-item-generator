	...
	it("produces valid QTI with response processing and feedback blocks", async () => {
		const item: AssessmentItem<[]> = {
			...
			feedbackPlan: {
				...
				combinations: [
					{ id: "FB__RESPONSE_1_A__RESPONSE_2_A", path: [ { responseIdentifier: "RESPONSE_1", key: "A" }, { responseIdentifier: "RESPONSE_2", key: "A" } ] },
					{ id: "FB__RESPONSE_1_A__RESPONSE_2_B", path: [ { responseIdentifier: "RESPONSE_1", key: "A" }, { responseIdentifier: "RESPONSE_2", key: "B" } ] },
					{ id: "FB__RESPONSE_1_B__RESPONSE_2_A", path: [ { responseIdentifier: "RESPONSE_1", key: "B" }, { responseIdentifier: "RESPONSE_2", key: "A" } ] },
					{ id: "FB__RESPONSE_1_B__RESPONSE_2_B", path: [ { responseIdentifier: "RESPONSE_1", key: "B" }, { responseIdentifier: "RESPONSE_2", key: "B" } ] }
				]
			},
			feedbackBlocks: {
		...
		expect(xml).toContain('<qti-feedback-block outcome-identifier="FEEDBACK__OVERALL" identifier="FB__RESPONSE_1_A__RESPONSE_2_A"')
		expect(xml).toContain('<qti-feedback-block outcome-identifier="FEEDBACK__OVERALL" identifier="FB__RESPONSE_1_A__RESPONSE_2_B"')
		expect(xml).toContain('<qti-feedback-block outcome-identifier="FEEDBACK__OVERALL" identifier="FB__RESPONSE_1_B__RESPONSE_2_A"')
		expect(xml).toContain('<qti-feedback-block outcome-identifier="FEEDBACK__OVERALL" identifier="FB__RESPONSE_1_B__RESPONSE_2_B"')
