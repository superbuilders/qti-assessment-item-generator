	...
	it("emits FEEDBACK__OVERALL for all combinations", () => {
		...
		const item: AssessmentItem<typeof widgetTypeKeys> = {
			...
			responseDeclarations: [
				...
				{ identifier: "RESPONSE_2", cardinality: "single", baseType: "identifier", correct: "A" }
			],
			body: null,
			widgets: null,
			interactions: null,
		...
		expect(xml).toContain('<qti-base-value base-type="identifier">FB_R1_A__R2_B</qti-base-value>')
		expect(xml).toContain('<qti-base-value base-type="identifier">FB_R1_B__R2_A</qti-base-value>')
		expect(xml).toContain('<qti-base-value base-type="identifier">FB_R1_B__R2_B</qti-base-value>')
		...
		expect(xml).toContain('<qti-base-value base-type="identifier">A</qti-base-value>')
