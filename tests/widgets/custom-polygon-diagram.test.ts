...
import { customPolygonDiagramExamples } from "../../examples/custom-polygon-diagram"
import type { Widget } from "../../src/widgets/registry"
import { generateWidget } from "../../src/widgets/widget-generator"

describe("Widget: custom-polygon-diagram", () => {
	const examples = customPolygonDiagramExamples as unknown as Widget[]
