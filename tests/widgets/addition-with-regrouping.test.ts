...
import { additionWithRegroupingExamples } from "../../examples/addition-with-regrouping"
import type { Widget } from "../../src/widgets/registry"
import { generateWidget } from "../../src/widgets/widget-generator"

describe("Widget: addition-with-regrouping", () => {
	const examples = additionWithRegroupingExamples as unknown as Widget[]
