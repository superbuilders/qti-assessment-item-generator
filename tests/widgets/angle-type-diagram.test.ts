...
import { angleTypeDiagramExamples } from "../../examples/angle-type-diagram"
import type { Widget } from "../../src/widgets/registry"
import { generateWidget } from "../../src/widgets/widget-generator"

describe("Widget: angle-type-diagram", () => {
	const examples = angleTypeDiagramExamples as unknown as Widget[]
