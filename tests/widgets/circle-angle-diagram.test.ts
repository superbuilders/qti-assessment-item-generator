...
import { circleAngleDiagramExamples } from "../../examples/circle-angle-diagram"
import type { Widget } from "../../src/widgets/registry"
import { generateWidget } from "../../src/widgets/widget-generator"

describe("Widget: circle-angle-diagram", () => {
	const examples = circleAngleDiagramExamples as unknown as Widget[]
