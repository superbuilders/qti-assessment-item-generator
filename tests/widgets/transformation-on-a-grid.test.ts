...
import { transformationOnAGridExamples } from "../../examples/transformation-on-a-grid"
import type { WidgetInput } from "../../src/widgets/registry"
import { generateWidget } from "../../src/widgets/widget-generator"

describe("Widget: transformation-on-a-grid", () => {
	const examples: WidgetInput[] = transformationOnAGridExamples
