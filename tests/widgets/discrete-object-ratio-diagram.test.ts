...
import { discreteObjectRatioDiagramExamples } from "../../examples/discrete-object-ratio-diagram"
import type { WidgetInput } from "../../src/widgets/registry"
import { generateWidgetLegacy } from "../../src/widgets/widget-generator"

describe("Widget: discrete-object-ratio-diagram", () => {
	const examples: WidgetInput[] = discreteObjectRatioDiagramExamples
