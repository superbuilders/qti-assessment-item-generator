...
if (!process.env.OPENAI_API_KEY) {
	...
	throw errors.new(
		'OPENAI_API_KEY environment variable is not set - please create a .env file and add your key: OPENAI_API_KEY="your-key-here"'
	)
}
...
async function runTestPipeline() {
	...
	const result = await errors.try(async () => {
		...
		logger.info("pipeline test succeeded")
