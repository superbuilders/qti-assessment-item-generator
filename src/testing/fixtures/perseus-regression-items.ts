...
export const soupVolumeEstimation = {
	hints: [
		...
		},
		{
			images: {},
			content:
				"Is the volume of a bowl of soup closer to $3$ cups or $3$ quarts?",
			replace: false,
			widgets: {}
		},
		{
	...
	hints: [
		{
			images: {},
			content:
				"We want to know how many one-centimeter cubes can we fit in the prism.",
			replace: false,
			widgets: {}
		},
		{
	...
	hints: [
		{
			images: {},
			content:
				"First, let's show $n-q$ on the number line.  \n\n[[☃ image 1]]\n\n",
			replace: false,
			widgets: {
				"image 1": {
					type: "image",
		...
		},
		{
			images: {},
			content:
				"Now, let's show $q-n$ on the number line.  \n\n[[☃ image 1]]\n\n",
			replace: false,
			widgets: {
				"image 1": {
					type: "image",
